...
#define MICROPY_PY_MACHINE_SPI_MSB              (0) // const only
#define MICROPY_PY_MACHINE_SPI_LSB              (1) // const only
...
#define MICROPY_USE_INTERNAL_PRINTF				(0) // xmdebug // disable upy internal printf
